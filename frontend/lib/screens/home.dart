              ...
              child: SingleChildScrollView(
                ...
                Padding(padding:EdgeInsets.all(10),
                  child: Container(
                    ...
                    width:screenWidth *1,
                    decoration: BoxDecoration(color: const Color.fromARGB(255, 153, 207, 251),
                    borderRadius: BorderRadius.circular(25),),
                    
                    child: Column(mainAxisAlignment: MainAxisAlignment.start,crossAxisAlignment: CrossAxisAlignment.start,
                      children:[
                      Padding(padding:EdgeInsets.all(10),child: Text("Your current balance is",style: TextStyle(fontFamily: 'basic',fontSize: 20))),
                      Row(children:[ 
                        Padding(padding: EdgeInsets.fromLTRB(20,0,0,0),child: Text(balance.toString(),style:TextStyle(fontWeight: FontWeight.bold,fontSize: 50, color: const Color.fromARGB(255, 0, 84, 152)))),
                        Spacer(),
                        Padding(padding: EdgeInsets.fromLTRB(0, 0, 20, 0),
                          child: Container(
                            ...
                            child: CircleAvatar(radius: 35,backgroundColor: Colors.black,child: Padding(padding: EdgeInsets.all(5),child: ClipOval(child: Image.asset("assets/images/logo.png",fit: BoxFit.contain))),)),
                          ),
                        )
                      ])
                    ])
